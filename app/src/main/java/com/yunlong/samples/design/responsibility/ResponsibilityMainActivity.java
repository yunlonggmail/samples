package com.yunlong.samples.design.responsibility;
...
import com.yunlong.samples.design.strategy.StrategyImplListActivity;
...
public class ResponsibilityMainActivity extends BaseActivity {

    /**
     * 隐式意图
     */
    public static final String INTENT_ACTION = "com.yunlong.samples.design.pattern.responsibility.Main";
    /**
     * 数据
     */
    @Bind(R.id.rv_list)
